...
//   }
    ...
    */
   def max[ A ] : TotalOrder[ A ] = new Impl[ A ]( new Size ) {
      tag = Int.MaxValue
...
//         }
   ...
   private class Impl[ A ]( protected val totalSize: TotalOrder.Size ) // (_t: Int)
   extends TotalOrder[ A ] {
