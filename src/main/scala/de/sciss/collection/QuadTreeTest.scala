...
//         Seq( cv )
         ...
         val rt   = RandomizedSkipQuadTree[ PointLike ]( quad0 )( map.toSeq: _* )
...
//println( keys3 )
         ...
         val dt   = DeterministicSkipQuadTree[ PointLike ]( quad0 )( seq3: _* )
//         dt += Point(397,500) -> ()
//         dt += Point(418,6) -> ()
...
//         add( Some( dt.lastTree ), Nil )
   ...
   class Test3 {
      ...
      def randFill( t: SkipQuadTree[ Point ]) {
         // seed = 2
         val n     = 0x467 // 0x2F80
         for( i <- 0 until n ) {
...
//            m.put( k, v )
      ...
      val t = RandomizedSkipQuadTree.empty[ Point ]( q )
      randFill( t )
...
//         Point(1421478041,2034995035), Point( 767054239, 757771480), Point(1654109098, 412552175), Point(1482054540,1464283949)
         ...
         RandomizedSkipQuadTree.random.setSeed( 0L )
         val t = RandomizedSkipQuadTree[ PointLike ]( q )( pts: _* )
...
//      println( q2 -> res2 )
         ...
         val v = new SkipQuadTreeView( t )
            v.highlight = Set( /* Point(1609162490,1507881173), */ Point(1598649701,1592263107), Point(1657161143,1524021651) )
...
//         v.gridColor = new Color( 0x00, 0x00, 0x00, 0x30 )
   ...
   class Test5 {
      ...
      val t       = RandomizedSkipQuadTree[ Point ]( quad )( pts: _* )
