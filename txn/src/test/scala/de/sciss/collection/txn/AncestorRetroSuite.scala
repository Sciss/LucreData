...
//
//      final protected val preObserver:  TotalOrder.Map.RelabelObserver[ S, Self#V ] = new OrderObserver
//      final protected val postObserver: TotalOrder.Map.RelabelObserver[ S, Self#V ] = new OrderObserver
//      def root: Self#V
//
...
//
//      final protected class OrderObserver extends TotalOrder.Map.RelabelObserver[ S, Self#V ] {
//         type E = TotalOrder.Map.Entry[ S, Self#V ]
